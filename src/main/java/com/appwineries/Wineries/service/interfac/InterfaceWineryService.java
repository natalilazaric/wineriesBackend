...
public interface InterfaceWineryService {
    ...
    Response addNewWinery(Long userId, MultipartFile photo, String name, String location, double latitude, double longitude, boolean food, String description, List<String> wines, Map<String, String> extras, Map<String, String> offers);
